import imgFooter from "../assets/femme.svg"
    ...
    <div className='relative w-full h-[750px]' style={{
      ...
      <div className='relative z-10 flex justify-center flex-col items-center h-full'>
        <div className='text-center max-w-xl px-4'>
          ...
          <button className='bg-primary-500 hover:bg-primary-600 text-white px-10 py-4 rounded-xl text-lg font-medium transition-all shadow-lg transform hover:scale-105'>
