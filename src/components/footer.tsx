      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12'>
        ...
        <div className='flex flex-col space-y-4'>
          <div className='flex items-center mb-3'>
            ...
            <span className='text-2xl font-extrabold ml-3 text-primary-500'>UNIFY</span>
          </div>
        ...
        <div className='flex flex-col space-y-3'>
          ...
          <a href='#' className='text-sm text-gray-400 hover:text-primary-500 transition-colors duration-300'>Accueil</a>
          <a href='#' className='text-sm text-gray-400 hover:text-primary-500 transition-colors duration-300'>À propos</a>
          <a href='#' className='text-sm text-gray-400 hover:text-primary-500 transition-colors duration-300'>Nos abonnements</a>
          <a href='#' className='text-sm text-gray-400 hover:text-primary-500 transition-colors duration-300'>Contact</a>
        </div>
        ...
        <div className='flex flex-col space-y-3'>
          ...
          <div className='flex flex-col space-y-2'>
            <a href='#' className='flex items-center bg-dark text-white px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors duration-300'>
