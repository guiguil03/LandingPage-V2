        ...
        {showSuccessAlert ? (
          ...
          >
            ...
            <form
              ...
              className="px-8 pb-8 sm:px-10 sm:pb-10 pt-6"
            >
              {errorMessage && (
              ...
              <div className="flex items-center gap-3 mt-8">
                {step > 1 && (
                  <button
                    ...
                    className="py-3.5 px-5 rounded-2xl text-[15px] font-medium text-white border border-white/[0.08] hover:border-white/20 hover:text-white transition-all duration-200"
                  >
                    Retour
                  </button>
                )}
